...
This lib requires **Node.js >=20**, **NestJS ^10.0.0 || ^11.0.0 || ^12.0.0**, **ioredis ^5.0.0** or **redis ^5.6.0**.

- If you depend on **ioredis 5** & **NestJS 10/11/12**, please use version **11** of the lib.
